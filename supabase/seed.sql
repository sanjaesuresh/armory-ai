...
-- Generated: 2026-07-02T01:03:14.137Z
...
4. If asked to write for a channel not listed above, flag it and confirm before proceeding.',
  E'[{"key":"brandName","label":"Brand name","type":"text","required":true,"helpText":"The exact name of your brand as it should appear in all outputs."},{"key":"hasBrandVoice","label":"Do you have brand voice guidelines?","type":"boolean","default":false,"required":false,"helpText":"Turn this on if you will upload a brand voice or style guide as a knowledge file."},{"key":"channels","label":"Active marketing channels","type":"multiselect","options":["Email","Instagram","LinkedIn","X (Twitter)","Facebook","TikTok","Blog"],"default":["Email","Instagram","LinkedIn"],"required":true,"helpText":"Select every channel your marketing team actively publishes to."},{"key":"tone","label":"Overall tone of voice","type":"select","options":["Professional","Conversational","Playful","Authoritative","Inspirational"],"default":"Professional","required":true,"helpText":"Pick the single tone that best describes your brand personality."}]',
